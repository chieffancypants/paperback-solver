...
export function HeartIcon (props:IconProps) {
    const { size = 20 } = props
    return (
        <svg className="text-red-500" width={size} height={size} viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" clipRule="evenodd" d="M10 18.4l-1.6-1.6C3.6 12.1 0 9.2 0 5.5 0 2.4 2.4 0 5.5 0c1.9 0 3.7.9 4.5 2.4C10.8.9 12.6 0 14.5 0 17.6 0 20 2.4 20 5.5c0 3.7-3.6 6.6-8.4 11.3L10 18.4z"></path>
        </svg>
    )
}
...
export function GithubIcon (props:IconProps) {
    const { size = 20 } = props
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="-mt-2">
...
export function XCircleIcon(props: IconProps) {
    ...
    return (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" width={size} height={size} viewBox="0 0 24 24">
            <path fill="#C4BA8A" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Z" />
